...
kobman_user_config_file="${kobman_etc_folder}/user-config.config"
...
curl -sL "https://raw.githubusercontent.com/${KOBMAN_NAMESPACE}/KOBman/user_config_test/dist/environments" > tmp.txt
sed -i 's/,/ /g' tmp.txt 
